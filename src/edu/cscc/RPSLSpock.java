 ...
 * @author Josh Suiter, October 18, 2020, for CSCI 2467
 */
public class RPSLSpock {
     ...
     * isValidPick method
     * @param pick
     * @return a boolean value that indicates whether the pick was valid.
     */
    ...
    /**
     * generatePick method
     * @return a String that indicates the pick.
     */
     ...
     * @param c_pick the computer picks
     * @param h_pick the human picks
     * @return a boolean value that indicates whether the computer won.
     */
